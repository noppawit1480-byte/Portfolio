...
const PORTFOLIO_DATA = {
  ...
  profile: {
    ...
    taglines: [
      ...
      "ออกแบบฐานข้อมูลและ API ด้วย Node.js, SQL และ PostgreSQL",
    ],
  },
  ...
  // ---------- ผลงาน ----------
  // ⚠⚠ สำคัญมากสำหรับใบสมัคร Backend Developer ที่ PDKM: ตอนนี้ส่วนนี้ยังว่างอยู่
  //    บริษัทจะดูโค้ด/ผลงานจริงเป็นหลัก แนะนำให้ใส่โปรเจกต์ที่โชว์ฝั่ง Backend ได้ชัดเจน เช่น
  //    - โปรเจกต์ที่สร้าง REST API ด้วย Node.js
  //    - โปรเจกต์ที่ออกแบบและเชื่อมต่อฐานข้อมูล (Supabase/PostgreSQL, MySQL)
  //    - เว็บระบบแจ้งซ่อมที่เคยพัฒนาตอนฝึกงาน (ถ้ามีซอร์สโค้ดหรือ demo ก็ใส่ได้เลย)
  //    ตัวอย่างการเพิ่ม 1 โปรเจกต์:
  // {
